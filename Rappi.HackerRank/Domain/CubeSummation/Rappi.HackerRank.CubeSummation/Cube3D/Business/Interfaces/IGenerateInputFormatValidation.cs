namespace Rappi.HackerRank.CubeSummation.Cube3D.Business.Interfaces
{
    ...
    public interface IGenerateInputFormatValidation
    {
        ...
        /// <summary>
        /// Determines whether [is the number dimension of matrix between range] [the specified input format model].
        /// </summary>
        /// <param name="inputFormatModel">The input format model.</param>
        /// <returns></returns>
        bool IsTheNumberDimensionOfMatrixBetweenRange(InputFormatModel inputFormatModel);
